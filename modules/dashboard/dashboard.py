...
# student scores - wopg
		    ...
		    lin = []
		    for key1 in ['a1course', 'a2course', 'a3course','a4course','a5course','a6course','a7course','a8course','a9course','a10course','a11course','a12course','postcourse', 'overall_score','ReviewA_U5','ReviewA_U6']:
...
class PostcourseAggregator(object):
	...
	for key in feedb.keys():
	    lista = []
            lista =feedb[key]
            li = []
	    lim ={'a1course':mn[0],'a2course':mn[1],'a3course':mn[2],'a4course':mn[3],'a5course':mn[4]}
...
#            lim['a12course']=mn[11]
		...
		if key <> 'postcourse' and key <> 'ReviewA_U5' and key <> 'ReviewA_U6':
